    ...
    <div>
      ...
      <div className="lg:w-2/3 w-full lg:pr-4">
        ...
        <div className="grid md:grid-cols-2 gap-4 mb-4">
          <div>
            ...
            <Select
              ...
              onChange={(option) => dispatch(setFormData({ bedrooms: option }))}
            />
          </div>
          <div>
            <label className="self-stretch text-black text-sm font-semibold leading-[normal] mb-3 block">
        ...
        <div className="grid md:grid-cols-4 grid-cols-2 gap-4 mb-4 items-end">
          ...
          <div>
            ...
            <Select
              ...
              onChange={(option) => dispatch(setFormData({ landSize: option }))}
            />
          </div>
          <div>
            <Select
        ...
        <div className="my-4">
          ...
          <label className="text-[#2C363F] text-sm font-semibold leading-[normal] mt-3 mb-4 block">
            Sales Method
          </label>
            ...
            <div>
              <label className="inline-flex items-center text-sm font-medium">
                <input
                  ...
                  onChange={handleRadioChange}
                />
                <span className="ml-2">PrivateTreaty</span>
              </label>
            </div>
            <div>
              <label className="inline-flex items-center text-sm font-medium">
        ...
        <div className="flex space-x-4 mb-4 mt-4 w-full">
          <div className="flex items-center ">
            <label className="text-black text-sm font-semibold leading-normal text-center mr-2">
              From
            </label>
            <input
              type="text"
              className="form-input px-2  h-[50px] shrink-0 rounded border [background:var(--Primary-Base-White,#FFF)#E4E3E4"
              placeholder="e.g. 49968"
              value={formData.postcode}
              onChange={(e) =>
                dispatch(setFormData({ postcode: e.target.value }))
