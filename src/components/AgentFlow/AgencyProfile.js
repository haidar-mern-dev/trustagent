...
const AgencyProfile = () => {
  return (
    <div className="px-4 w-full flex flex-col gap-6">
      ...
      <div className="md:w-[55%] w-full h-auto rounded-[4px] border border-[#E4E3E4] bg-white flex md:items-start items-center justify-center py-5">
        <div className="w-[96%] h-[94%] flex flex-col gap-4 justify-start">
          ...
          >
            <Form className="w-full grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <button
                type="submit"
                className="col-span-1 md:col-span-2 w-full md:w-[81px] h-[44px] bg-[#FFBF00] text-[#2C363F] rounded-[4px] font-sans font-medium text-[14px]"
              >
                Save
              </button>
            </Form>
