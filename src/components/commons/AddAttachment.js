...
const PassportOptions = [{ value: "passport", label: "Passport" }];
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <input
        ...
        onChange={(e) => dispatch(setFormData({ ownerName: e.target.value }))}
      ...
      <div>
        ...
        <Select
          ...
          className="w-full react_select font-sans font-sans font-normal text-[14px] text-[#8c8c8c]"
      ...
      <Select
        ...
        value={PassportOptions?.find(
          (option) => option?.value === formData?.passport?.value
        )}
        onChange={(option) => dispatch(setFormData({ passport: option }))}
      />
